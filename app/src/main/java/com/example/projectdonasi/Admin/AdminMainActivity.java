...
public class AdminMainActivity extends AppCompatActivity implements NavigationVisibilityListener {
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (itemId == R.id.nav_home) {
                    ...
                    selectedFragment = new AdminPersonFragment();
                } else if (itemId == R.id.nav_donation){
                    selectedFragment = new AdminDonationFragment();
